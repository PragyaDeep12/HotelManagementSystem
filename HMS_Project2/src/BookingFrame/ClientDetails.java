...
public class ClientDetails extends JFrame  {
	...
	public ClientDetails() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientDetails.class.getResource("/BookingFrame/hotelpics/iconImg/1486107437_home_blue.png")));
		...
		lblPassword.setFont(new Font("Californian FB", Font.BOLD | Font.ITALIC, 18));
		lblPassword.setBounds(496, 358, 115, 32);
		contentPane.add(lblPassword);
		passwordField = new JPasswordField();
		passwordField.setBounds(629, 358, 161, 32);
		contentPane.add(passwordField);
		
		JLabel lblConfirmPassword = new JLabel("Confirm Password");
		lblConfirmPassword.setFont(new Font("Californian FB", Font.BOLD | Font.ITALIC, 18));
		lblConfirmPassword.setForeground(new Color(255, 255, 255));
		lblConfirmPassword.setBounds(489, 415, 148, 32);
		contentPane.add(lblConfirmPassword);

		
		passwordField_1 = new JPasswordField();
		passwordField_1.setBounds(647, 415, 172, 32);
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				new Client(textField_1.getText(),textField_2.getText(),textField_3.getText(),addr,textField_5.getText(),Gender,textField_6.getText(),textField_7.getText(),passwordField.getText());
		...
		btnSubmit.setIcon(new ImageIcon(ClientDetails.class.getResource("/BookingFrame/hotelpics/iconImg/1486113792_Button White Check.png")));
		btnSubmit.setFont(new Font("Cambria", Font.BOLD | Font.ITALIC, 15));
		btnSubmit.setBounds(915, 536, 127, 41);
		...
		btnNewButton.setIcon(new ImageIcon(ClientDetails.class.getResource("/BookingFrame/hotelpics/iconImg/1486107877_radio-button_off.png")));
		btnNewButton.setFont(new Font("Cambria", Font.BOLD | Font.ITALIC, 15));
		btnNewButton.setBounds(731, 536, 129, 41);
		...
		lblNewLabel_2.setIcon(new ImageIcon(ClientDetails.class.getResource("/BookingFrame/hotelpics/hotelpics/new.jpg")));
		lblNewLabel_2.setBounds(0, 0, 410, 749);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon(ClientDetails.class.getResource("/BookingFrame/hotelpics/hotelpics/chambers-hotel-new-york-home4-top (1).jpg")));
