...
//	 *///public Billing() {
	...
	public Billing(String City,String UserName,String Booked_Food,int Food_Index,int Room_Price,int No_of_Room,int days,int plate,int Room_days,int Visited) {
		...
		String Food1=null;
		JOptionPane.showMessageDialog(null, "Congrats You got a Discount coz u Visted "+Visited+" Times");
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				BufferedImage bi=robot.createScreenCapture(new Rectangle((int)p.getX(),100,contentPane.getWidth(),contentPane.getHeight()-15));
                try {
		...
		lblCustomerRequestedTo.setBounds(54, 410, 366, 38);
