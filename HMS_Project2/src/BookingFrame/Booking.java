...
@SuppressWarnings({ "unchecked", "rawtypes" })
	...
	int o=0;
		...
		lblNewLabel.setIcon(new ImageIcon(Booking.class.getResource("/BookingFrame/hotelpics/hotelpics/140596_275_z.jpg")));
			...
			public void actionPerformed(ActionEvent arg0) {
				try{
				  ...
				  //  SimpleDateFormat dFormat1=new SimpleDateFormat("YYYY:MM:dd");
					String d2=dFormat.format(dateChooser_chkout.getDate());
					...
					*/
					...
					if(chkindate.compareTo(today)<0)
					{
						JOptionPane.showMessageDialog(null,"Booking for these dates not allowed");
					}
					else	if(chkindate.compareTo(chkoutdate)<0)
						{
