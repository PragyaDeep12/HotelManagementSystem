...
public class RoomTable extends JFrame {
	...
	void reset(String d1,String d2,String City, String UserName,String Booked_Food,int Price,int num,int days,int plate,int d3)
	{
		...
		this.dispose();
			...
			i=JOptionPane.showConfirmDialog(null,"wanna book more rooms?");
	...
	public static class RoomDetails
	{
		...
		public static void RoomTable(int i,int count,String City,String a,String b,String c,String d)
		{
			...
			Object rowData[]=new Object[4];
				...
				File User_Room=new File("Resources/City/UserBookRooms.txt");
				File Clone_User_Room=new File("Resources/City/CloneUserBooked.txt");
				
				try {
					PrintWriter d=new PrintWriter(new FileWriter(User_Room,true));
					d.close();
					copyFile(User_Room,Clone_User_Room);
				...
				try{ 
					 ...
					 x1=new Scanner(Clone_User_Room);
					
					 g1=new PrintWriter(new FileWriter(User_Room));
					int i=1;
					while(x1.hasNext())
					{
						String Usr=x1.next();
